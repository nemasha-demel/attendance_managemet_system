...
if (isset($_POST['update'])) {
    ...
    if ($newPassword !== $confirmPassword) {
        ...
        $fetchPasswordQuery = "SELECT password FROM user WHERE lecturer_id = ?";
        ...
        $fetchPasswordStmt->bind_param("s", $lecturer_id);
        ...
        if (password_verify($currentPassword, $row['password'])) {
            ...
            $updateUserQuery = "UPDATE user SET password = ? WHERE lecturer_id = ?";
            ...
            $updateUserStmt->bind_param("ss", $hashedPassword, $lecturer_id);
